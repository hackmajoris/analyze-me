...
function useLatestDownloads() {
  const [urls, setUrls] = useState({ mac: '#', windows: '#', linux: '#' })

  useEffect(() => {
    fetch('https://api.github.com/repos/hackmajoris/analyze-me/releases/latest')
      .then(r => r.json())
      .then(data => {
        ...
        const linux = assets.find(a => a.name.includes('linux') && a.name.endsWith('.tar.gz'))?.browser_download_url ?? '#'
        setUrls({ mac, windows, linux })
      })
      .catch(() => {})
  }, [])
      ...
      <section className="cta-section">
        <div className="cta-card">
          ...
          <div className="download-buttons">
            ...
            <a href={downloads.windows} className="download-btn" target="_blank" rel="noopener">
            ...
            <a href={downloads.linux} className="download-btn" target="_blank" rel="noopener">
